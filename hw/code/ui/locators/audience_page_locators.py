...
class AudiencePageLocators():
    ...
    def SOURCE_ITEM(item_name):
        return (
            By.XPATH,
            f"//*[contains(@class, 'SourceTypeSelector_button__')]//*[text()='{item_name}']",
        )
    ...
    KEY_PHRASES_INPUT = (
        By.XPATH,
        "//*[contains(@class, 'KeyPhrases_textarea__')]/textarea",
    )
    MINUS_PHRASES_INPUT = (
        By.XPATH,
        "//*[contains(@class, 'KeyPhrases_negationPhrases__')]//textarea",
    )
    PERIOD_INPUT = (By.XPATH, "//*[contains(@class, 'Context_daysInput__')]/input")

    MODAL_PAGE_SUBMIT_BUTTON = (
        By.XPATH,
        "//*[contains(@class, 'vkuiTappable--hasActive') and @type='submit']",
    )
    ...
    CREATED_AUDIENCE_TITLE = (
        By.XPATH,
        "//*[contains(@class, 'NameCell_wrapper__')]/h5",
    )
